...
function AboutPage(props) {
    let content = {
        ...
        FR: {
          ...
          P2: "Pour de nombreux Canadiens, les changements climatiques représentent non seulement une préoccupation, mais une frustration quotidienne : que puis-je faire ? L’objectif premier du projet pour un Outaouais vert et prospère est de nous rassembler. Outaouais a la chance d'avoir des personnes exceptionnelles aux idées innovantes, et des leaders communautaires solides. Que pourrions-nous accomplir si nous réunissions nos meilleures idées et orientions nos investissements vers un objectif commun ?",
          P3: "Ainsi, l’idée principale derrière ce projet est de mettre l'accent sur des solutions innovatrices et porteur de changement qui nous permettront de relever les défis de l'avenir. Que faudra-t-il pour créer un Outaouais prospère d'ici 2040? Que devrions-nous faire pour nous mettre sur la voie d'une prospérité durable ?",
